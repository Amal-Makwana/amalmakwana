  ...
  return (
    <article className="mx-auto max-w-3xl space-y-6">
      <div className="space-y-3">
        <p className="text-sm uppercase tracking-[0.14em] text-cyan-100/80">Article</p>
      ...
      <section className="space-y-4 text-slate-200">
        <h2 className="text-xl font-semibold text-slate-100">Key ideas</h2>
      ...
      <div className="flex flex-wrap gap-3 pt-2">
        <Link
          href="/articles"
          className="inline-flex min-h-11 items-center rounded-md border border-cyan-200/30 px-4 py-2 text-sm text-cyan-100"
        >
          Back to Articles
        </Link>
        <a
          ...
          className="inline-flex min-h-11 items-center rounded-md bg-cyan-500 px-4 py-2 text-sm font-medium text-slate-950"
        >
